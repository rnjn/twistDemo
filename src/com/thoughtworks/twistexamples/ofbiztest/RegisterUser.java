...
public class RegisterUser {
	...
	public void setUserNameWithPrefix(String string1) throws Exception {
		browser.findElement(By.id("USERNAME")).sendKeys(string1 + java.util.UUID.randomUUID());
	...
	public void verifyUserHasBeenCreated(String string1, String string2) throws Exception {
		assertTrue(browser.findElement(By.id("welcome-message")).getText()
				.contains(string1) && browser.findElement(By.id("welcome-message")).getText()
				.contains(string2));
