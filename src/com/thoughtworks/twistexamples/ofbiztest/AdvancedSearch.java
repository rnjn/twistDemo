...
public class AdvancedSearch {
	...
	public void setKeywordTo(String string1) throws Exception {
		browser.findElement(By.name("advtokeywordsearchform"))
				.findElement(By.name("SEARCH_STRING")).sendKeys(string1);
	...
	public void verifyThatNoResultsAreFound() throws Exception {
		assertTrue(browser.findElements(By.tagName("H2")).get(0).getText()
				.contains("No results found."));

	}

	public void removeConstraintsFor(String string1) throws Exception {
		List<WebElement> linkButtons = browser.findElements(By
				.className("buttontext"));
		for (WebElement webElement : linkButtons) {
			if (webElement.findElement(By.xpath("..")).getText()
					.contains(string1)) {
				webElement.click();
				return;
			}
